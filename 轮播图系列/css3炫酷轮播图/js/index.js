var circles=document.querySelectorAll(".picFoot p span")
	...
	,imgWidth=parseInt(getComputedStyle(slide.querySelector("span")).width)	//这里不能用offsetWidth去取宽度，因为一上来span标签是display:none的，所以取不到
	,imgWrap=slide.children[0]			//小图的父级
	,timer;
...
var next=document.querySelector(".next")
	...
	,textArr=['《天才捕手》定档3.10 科林·费斯调教裘德·洛','《西游记》的N种可能','《爱乐之城》 - 北京147家影院上映1122场','《极限特工：终极回归》 - 北京152家影院上映1623场','《非凡任务》曝预告海报 黄轩变身硬汉大秀肌肉']


	,col=15						//列数
	,w=imgBox.offsetWidth/col	//一个方块的宽度
	,h=imgBox.offsetHeight		//一个方块的高度
	,ln=0						//上一张图片的索引
	,cn=0						//当前图片的索引
	,divs=null					//所有的方块
	,canClick=true;				//能否进行下次点击
